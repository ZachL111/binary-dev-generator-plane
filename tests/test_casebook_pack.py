"""Regression checks for the binary-dev-generator-plane casebook."""
...
from casebook.harness import assert_expected, binary_dev_generator_plane_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(binary_dev_generator_plane_summary(), assert_expected())
